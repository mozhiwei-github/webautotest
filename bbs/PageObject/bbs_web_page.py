...
from bbs.item_code import TopElementItem, TopHotEvent, HotTopic
import random
...
class BbsWebpage(WebPage):
    ...
    def click_hottopic(self, original_window):
        """
        点击首页顶部任一热门话题
        @param original_window: 初始窗口句柄ID
        @return:
        """
        if not self.find_element((By.XPATH, HotTopic.NOMORE.value)):
        ...
        item_title = self.get_text((By.XPATH, '//div[@class="_ht_t1_ont9d_379"]'), element=item)
